...
const typeNum = (arr) => {
  return arr.filter(value => isNaN(value) === false);
};
...
const containsAnd = (arr) => { return arr.filter(str => str.includes('and'));};
...
const oddValues = (arr) => { return arr.filter(num => (num % 2 !== 0));};
