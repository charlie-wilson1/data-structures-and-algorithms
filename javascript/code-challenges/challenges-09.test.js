...
const updateNumbers = (obj) => {
  let thing = Object.keys(obj);
  let newThing = thing.map(str => {
    let newStr = str.concat(': ');
    return newStr;
  });

  let thing2 = Object.values(obj);
  let newThing2 = thing2.map((str, i) => {
    let newStr2 = newThing[i].concat(str);
    return newStr2;
  });
  return newThing2;
};
