...
const listFoods = (recipe) => {
  ...
  let one = recipe.ingredients[0].slice(recipe.ingredients[0].indexOf('Gruffalo'), recipe.ingredients[0].length);
  let two = recipe.ingredients[1].slice(recipe.ingredients[1].indexOf('oats'), recipe.ingredients[1].length);
  let three = recipe.ingredients[2].slice(recipe.ingredients[2].indexOf('brown'), recipe.ingredients[2].length);
  let four =recipe.ingredients[3].slice(recipe.ingredients[3].indexOf('flour'), recipe.ingredients[3].length);
  let five = recipe.ingredients[4].slice(recipe.ingredients[4].indexOf('pure'), recipe.ingredients[4].length);
  let six = recipe.ingredients[5].slice(recipe.ingredients[5].indexOf('chopped'), recipe.ingredients[5].length);
  let seven = recipe.ingredients[6].slice(recipe.ingredients[6].indexOf('baking'), recipe.ingredients[6].length);
  let eight = recipe.ingredients[7].slice(recipe.ingredients[7].indexOf('baking'), recipe.ingredients[7].length);
  let nine = recipe.ingredients[8].slice(recipe.ingredients[8].indexOf('cinnamon'), recipe.ingredients[8].length);
  let ten = recipe.ingredients[9].slice(recipe.ingredients[9].indexOf('melted'), recipe.ingredients[9].length);
  let eleven = recipe.ingredients[10].slice(recipe.ingredients[10].indexOf('fresh'), recipe.ingredients[10].length);

  let myArr = [one, two, three, four, five, six, seven, eight, nine, ten, eleven];
  myArr.forEach(value => {result.push(value);});
  return result;
};
